      ...
      <div className="qualificationWrapper">
        <Container maxWidth="lg">
          ...
          <div className="fieldsTitle">
            <span onClick={() => toggled("education")} className={`education ${toggle === "education" ? "active": ""}`}>
              <FaGraduationCap />
              Təhsil
            </span>
            <span> | </span>
            <span onClick={() => toggled("experience")} className={`experience ${toggle === "experience" ? "active": ""}`}>
              <MdWork />
              Təcrübə
            </span>
          </div>
          <div className="qualSections">
            <div className={`qualContent ${toggle === "education" ? "active": "hidden"}`}>
            ...
            <div className={`qualContent ${toggle === "experience" ? "active": "hidden"}`}>
              <div className="qualData">
