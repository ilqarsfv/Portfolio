      ...
      <div className="portWrapper" id="portfolio">
        <Container maxWidth="lg">
          ...
          <div className="row">
            ...
            <a href="https://konturreklam.az/" target="_blank" className="portCard">
              <div className="portCardImg">
            ...
            <a href="https://srconstruction.az/" target="_blank" className="portCard">
              <div className="portCardImg">
            ...
            <a href="https://amazontravel.az/" target="_blank" className="portCard">
              <div className="portCardImg">
            ...
            <a href="https://integrogroup.az/" target="_blank" className="portCard">
              <div className="portCardImg">
